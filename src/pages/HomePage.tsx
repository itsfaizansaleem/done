...
const MOCK_PRODUCTS: Product[] = [
  ...
  {
    id: '2',
    name: 'Minimalist Icon Workspace',
    description: '150+ sharp, geometric icons for SaaS.',
    price: 18,
    category: 'Icon',
  ...
  {
    id: '3',
    name: 'Organic Grain Overlays',
    description: 'Authentic scan-based grain and dust textures.',
    price: 15,
    category: 'Texture',
    imageUrl: 'https://picsum.photos/seed/grain/800/600',
    author: 'Analog Lab',
    fileSize: '120MB',
    format: 'JPG, PNG'
  },
  {
    id: '4',
    name: 'Editorial Character Set',
    description: 'Trendy flat illustrations for editorial design.',
    price: 32,
    category: 'Illustration',
    imageUrl: 'https://picsum.photos/seed/char/800/600',
    author: 'Hana Studio',
    fileSize: '85MB',
    format: 'EPS, PNG'
  }
        ...
        <div className="lg:w-1/2 bg-brand-surface relative flex items-center justify-center p-12 lg:p-24 overflow-hidden">
          ...
          >
            <div className="flex-1 bg-white/[0.02] border border-white/5 mb-6 relative flex items-center justify-center overflow-hidden">
               <div className="text-[80px] lg:text-[120px] font-serif italic text-white/5 select-none absolute">Ve.</div>
               <img src="https://picsum.photos/seed/preview/800/1000" className="w-full h-full object-cover opacity-60 grayscale mix-blend-overlay" referrerPolicy="no-referrer" />
            </div>
            <div className="text-[10px] tracking-widest text-white/30 mb-2 uppercase">Item No. 402-A // Current Release</div>
            <div className="text-xl font-serif italic text-white">Organic Noise Brush Set</div>
            
            <div className="absolute -bottom-12 -right-12 text-[120px] font-serif italic text-white/[0.03] select-none pointer-events-none">04</div>
          </motion.div>
        </div>
      </section>
